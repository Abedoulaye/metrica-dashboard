...
const invoicesData = [
  ...
  {
    id: 2,
    invoiceId: "INV-2025-050",
    customer: "Globex Corporation",
    email: "billing@globex.com",
    status: "Paid",
    issueDate: "Oct 03, 2024",
    dueDate: "Oct 17, 2024",
    amount: "$8,500.00",
    balance: "$0.00",
  },
...
export function Invoices() {
  ...
  const filteredData = invoicesData.filter((customer) =>
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        <section className="two-col-grid-invoices">
          <div
          ...
          >
                    ...
                    <tr key={row.id}>
                      ...
                      <td>
                        <div className="cust-info">
                          ...
                          <div>
                            <div className="cust-name">{row.customer}</div>
            ...
            <div className="pagination-footer">
              <span className="pagination-text">
                Showing 1 to {filteredData.length} of 2,045 Invoices
              </span>
          ...
          <div className="invoice-side-panels">
            <div className="panel doughnut-panel">
              <h3 className="panel-title">Outstanding Balance</h3>
              <div className="doughnut-wrapper">
                ...
                #ef4444 95% 100%
                  ...
                  >
                    <div className="doughnut-hole">
                      <span className="doughnut-total">$34,980</span>
                      <span className="doughnut-label">Outstanding</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="legend">
                  <div className="legend-item">
                    ...
                    ></div>
                    <div className="legend-label">Paid</div>
                    <div className="legend-val">85%</div>
                    <div className="legend-val">$216k</div>
                  </div>
                  <div className="legend-item">
                    <div
                      className="legend-color"
                    ...
                    <div className="legend-val">10%</div>
                    <div className="legend-val">$24k</div>
                  </div>
                  <div className="legend-item">
                    <div
                      className="legend-color"
                    ...
                    ></div>
                    <div className="legend-label">Overdue</div>
                    <div className="legend-val">5%</div>
                    <div className="legend-val">$10k</div>
                  </div>
                </div>
              </div>
            </div>

            <div className="panel recent-payments-panel">
              <h3 className="panel-title">Recent Payments</h3>
              <div className="recent-payments-list">
                <div className="payment-row">
                  <span className="payment-customer">Sentry Analytics</span>
                  <span className="payment-amount paid">+$12,000</span>
                </div>
                <div className="payment-row">
                  <span className="payment-customer">Globex Corp.</span>
                  <span className="payment-amount paid">+$8,500</span>
                </div>
                <div className="payment-row">
                  <span className="payment-customer">Hooli</span>
                  <span className="payment-amount paid">+$4,200</span>
                </div>
                <div className="payment-row">
                  <span className="payment-customer">Vandelay Ind.</span>
                  <span className="payment-amount paid">+$1,200</span>
                </div>
              </div>
            </div>
          </div>
